...
enum Inter: String {
    ...
    case extraLight = "Inter-ExtraLight-BETA"
    case extraLightItalic = "Inter-ExtraLightItalic-BETA"
    case italic = "Inter-Italic"
    case light = "Inter-Light-BETA"
    case lightItalic = "Inter-LightItalic-BETA"
    case medium = "Inter-Medium"
    case mediumItalic = "Inter-MediumItalic"
    case regular = "Inter-Regular"
    case semiBold = "Inter-SemiBold"
    case semiBoldItalic = "Inter-SemiBoldItalic"
    case thin = "Inter-Thin-BETA"
    case thinItalic = "Inter-ThinItalic-BETA"
}
...
extension UINavigationBar {
    static func setTitleColor(_ color: UIColor) {
        ...
        appearance.backgroundColor = UIColor(Color.colorNeavyBlue)
