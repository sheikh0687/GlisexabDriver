...
struct Api_ScheduleList : Codable {
    let result : [Res_ScheduleList]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([Res_ScheduleList].self, forKey: .result)
...
struct Res_ScheduleList : Codable {
    let id : String?
    let user_id : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        user_request_stop = try values.decodeIfPresent([String].self, forKey: .user_request_stop)
    }
